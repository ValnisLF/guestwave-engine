            ...
            <TabsContent value="general" className="space-y-4">
                <div className="grid gap-4 md:grid-cols-2">
                  <div className="space-y-1">
                    <Label htmlFor="theme-primary">theme.primaryColor</Label>
                ...
                <div className="grid gap-4 md:grid-cols-2">
                  ...
                  <div className="space-y-1">
                    <Label htmlFor="footer-coordinates">footer.coordinates</Label>
              ...
              <TabsContent value="homepage" className="space-y-3">
                <Input name="homepage.hero.image" defaultValue={initial.homepage.hero.image} placeholder="homepage.hero.image" />
                <Input name="homepage.hero.title" defaultValue={initial.homepage.hero.title} placeholder="homepage.hero.title" />
                <Input name="homepage.hero.subtitle" defaultValue={initial.homepage.hero.subtitle ?? ''} placeholder="homepage.hero.subtitle" />
                <Input name="homepage.intro.title" defaultValue={initial.homepage.intro.title ?? ''} placeholder="homepage.intro.title" />
                <Textarea name="homepage.intro.paragraph" defaultValue={initial.homepage.intro.paragraph ?? ''} placeholder="homepage.intro.paragraph" rows={3} />
                <Input name="homepage.amenities.title" defaultValue={initial.homepage.amenities.title} placeholder="homepage.amenities.title" />
                <Textarea name="homepage.amenities.paragraph" defaultValue={initial.homepage.amenities.paragraph ?? ''} placeholder="homepage.amenities.paragraph" rows={3} />
                ...
                <Input name="homepage.amenities.image" defaultValue={initial.homepage.amenities.image ?? ''} placeholder="homepage.amenities.image" />
                <Input name="homepage.availability.title" defaultValue={initial.homepage.availability.title ?? ''} placeholder="homepage.availability.title" />
                <Textarea name="homepage.availability.paragraph" defaultValue={initial.homepage.availability.paragraph ?? ''} placeholder="homepage.availability.paragraph" rows={2} />
              ...
              <TabsContent value="laPropiedad" className="space-y-3">
                <Input name="laPropiedad.hero.image" defaultValue={initial.laPropiedad.hero.image} placeholder="laPropiedad.hero.image" />
                <Input name="laPropiedad.hero.title" defaultValue={initial.laPropiedad.hero.title} placeholder="laPropiedad.hero.title" />
                <Input name="laPropiedad.intro.title" defaultValue={initial.laPropiedad.intro.title ?? ''} placeholder="laPropiedad.intro.title" />
                <Textarea name="laPropiedad.intro.paragraph" defaultValue={initial.laPropiedad.intro.paragraph ?? ''} placeholder="laPropiedad.intro.paragraph" rows={3} />
                <Input name="laPropiedad.groundFloor.title" defaultValue={initial.laPropiedad.groundFloor.title} placeholder="laPropiedad.groundFloor.title" />
                <Textarea name="laPropiedad.groundFloor.paragraph" defaultValue={initial.laPropiedad.groundFloor.paragraph ?? ''} placeholder="laPropiedad.groundFloor.paragraph" rows={2} />
                ...
                <Input name="laPropiedad.groundFloor.image" defaultValue={initial.laPropiedad.groundFloor.image ?? ''} placeholder="laPropiedad.groundFloor.image" />
                <Input name="laPropiedad.firstFloor.title" defaultValue={initial.laPropiedad.firstFloor.title} placeholder="laPropiedad.firstFloor.title" />
                <Textarea name="laPropiedad.firstFloor.paragraph" defaultValue={initial.laPropiedad.firstFloor.paragraph ?? ''} placeholder="laPropiedad.firstFloor.paragraph" rows={2} />
                ...
                <Input name="laPropiedad.firstFloor.image" defaultValue={initial.laPropiedad.firstFloor.image ?? ''} placeholder="laPropiedad.firstFloor.image" />
                <Input name="laPropiedad.exterior.title" defaultValue={initial.laPropiedad.exterior.title} placeholder="laPropiedad.exterior.title" />
                <Textarea name="laPropiedad.exterior.paragraph" defaultValue={initial.laPropiedad.exterior.paragraph ?? ''} placeholder="laPropiedad.exterior.paragraph" rows={2} />
                ...
                <Input name="laPropiedad.exterior.image" defaultValue={initial.laPropiedad.exterior.image ?? ''} placeholder="laPropiedad.exterior.image" />
              ...
              <TabsContent value="turismo" className="space-y-3">
                <Input name="turismo.hero.image" defaultValue={initial.turismo.hero.image} placeholder="turismo.hero.image" />
                <Input name="turismo.hero.title" defaultValue={initial.turismo.hero.title} placeholder="turismo.hero.title" />
              ...
              <TabsContent value="reservas" className="space-y-3">
                <Input name="reservas.hero.image" defaultValue={initial.reservas.hero.image} placeholder="reservas.hero.image" />
                <Input name="reservas.hero.title" defaultValue={initial.reservas.hero.title} placeholder="reservas.hero.title" />
                <Input name="reservas.intro.title" defaultValue={initial.reservas.intro.title ?? ''} placeholder="reservas.intro.title" />
                <Textarea name="reservas.intro.paragraph" defaultValue={initial.reservas.intro.paragraph ?? ''} placeholder="reservas.intro.paragraph" rows={3} />
                <Input name="reservas.instructions.title" defaultValue={initial.reservas.instructions.title ?? ''} placeholder="reservas.instructions.title" />
                <Textarea name="reservas.instructions.paragraph" defaultValue={initial.reservas.instructions.paragraph ?? ''} placeholder="reservas.instructions.paragraph" rows={3} />
              ...
              <TabsContent value="tarifas" className="space-y-3">
                <Input name="tarifas.hero.image" defaultValue={initial.tarifas.hero.image} placeholder="tarifas.hero.image" />
                <Input name="tarifas.hero.title" defaultValue={initial.tarifas.hero.title} placeholder="tarifas.hero.title" />
                <Input name="tarifas.intro.title" defaultValue={initial.tarifas.intro.title ?? ''} placeholder="tarifas.intro.title" />
                <Textarea name="tarifas.intro.paragraph" defaultValue={initial.tarifas.intro.paragraph ?? ''} placeholder="tarifas.intro.paragraph" rows={3} />
                <Textarea name="tarifas.pricingTable" defaultValue={typeof initial.tarifas.pricingTable === 'string' ? initial.tarifas.pricingTable : ''} placeholder="tarifas.pricingTable" rows={2} />
              ...
              <TabsContent value="contacto" className="space-y-3">
                <Input name="contacto.hero.image" defaultValue={initial.contacto.hero.image} placeholder="contacto.hero.image" />
                <Input name="contacto.hero.title" defaultValue={initial.contacto.hero.title} placeholder="contacto.hero.title" />
                <Input name="contacto.intro.title" defaultValue={initial.contacto.intro.title} placeholder="contacto.intro.title" />
                <Textarea name="contacto.intro.paragraph" defaultValue={initial.contacto.intro.paragraph} placeholder="contacto.intro.paragraph" rows={3} />
                <Input name="contacto.phone" defaultValue={initial.contacto.phone ?? ''} placeholder="contacto.phone" />
                <Input name="contacto.email" defaultValue={initial.contacto.email ?? ''} placeholder="contacto.email" />
                <Input name="contacto.address" defaultValue={initial.contacto.address ?? ''} placeholder="contacto.address" />
                <ContenidosSaveActions />
              </TabsContent>
            </Tabs>
        </CardContent>
